...
const FeatureToggleKind = api_v1.FeatureToggleKind

// FeatureToggleLinkKind is the name of the type used to represent links
// to objects of type 'feature_toggle'.
const FeatureToggleLinkKind = api_v1.FeatureToggleLinkKind

// FeatureToggleNilKind is the name of the type used to nil references
// to objects of type 'feature_toggle'.
const FeatureToggleNilKind = api_v1.FeatureToggleNilKind

// FeatureToggle represents the values of the 'feature_toggle' type.
type FeatureToggle = api_v1.FeatureToggle
type FeatureToggleList = api_v1.FeatureToggleList
