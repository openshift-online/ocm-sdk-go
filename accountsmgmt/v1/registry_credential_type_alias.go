...
const RegistryCredentialKind = api_v1.RegistryCredentialKind

// RegistryCredentialLinkKind is the name of the type used to represent links
// to objects of type 'registry_credential'.
const RegistryCredentialLinkKind = api_v1.RegistryCredentialLinkKind

// RegistryCredentialNilKind is the name of the type used to nil references
// to objects of type 'registry_credential'.
const RegistryCredentialNilKind = api_v1.RegistryCredentialNilKind

// RegistryCredential represents the values of the 'registry_credential' type.
type RegistryCredential = api_v1.RegistryCredential
type RegistryCredentialList = api_v1.RegistryCredentialList
