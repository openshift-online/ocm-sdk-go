...
const OrganizationKind = api_v1.OrganizationKind

// OrganizationLinkKind is the name of the type used to represent links
// to objects of type 'organization'.
const OrganizationLinkKind = api_v1.OrganizationLinkKind

// OrganizationNilKind is the name of the type used to nil references
// to objects of type 'organization'.
const OrganizationNilKind = api_v1.OrganizationNilKind

// Organization represents the values of the 'organization' type.
type Organization = api_v1.Organization
type OrganizationList = api_v1.OrganizationList
