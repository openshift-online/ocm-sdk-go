...
const CloudResourceKind = api_v1.CloudResourceKind

// CloudResourceLinkKind is the name of the type used to represent links
// to objects of type 'cloud_resource'.
const CloudResourceLinkKind = api_v1.CloudResourceLinkKind

// CloudResourceNilKind is the name of the type used to nil references
// to objects of type 'cloud_resource'.
const CloudResourceNilKind = api_v1.CloudResourceNilKind

// CloudResource represents the values of the 'cloud_resource' type.
type CloudResource = api_v1.CloudResource
type CloudResourceList = api_v1.CloudResourceList
