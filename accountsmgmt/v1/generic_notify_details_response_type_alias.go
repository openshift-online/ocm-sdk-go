...
const GenericNotifyDetailsResponseKind = api_v1.GenericNotifyDetailsResponseKind
...
const GenericNotifyDetailsResponseLinkKind = api_v1.GenericNotifyDetailsResponseLinkKind

// GenericNotifyDetailsResponseNilKind is the name of the type used to nil references
// to objects of type 'generic_notify_details_response'.
const GenericNotifyDetailsResponseNilKind = api_v1.GenericNotifyDetailsResponseNilKind
...
type GenericNotifyDetailsResponse = api_v1.GenericNotifyDetailsResponse
type GenericNotifyDetailsResponseList = api_v1.GenericNotifyDetailsResponseList
