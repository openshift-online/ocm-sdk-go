...
// of type 'version'.
const VersionKind = api_v1alpha1.VersionKind

// VersionLinkKind is the name of the type used to represent links
// to objects of type 'version'.
const VersionLinkKind = api_v1alpha1.VersionLinkKind

// VersionNilKind is the name of the type used to nil references
// to objects of type 'version'.
const VersionNilKind = api_v1alpha1.VersionNilKind

// Version represents the values of the 'version' type.
//
// Representation of an _OpenShift_ version.
type Version = api_v1alpha1.Version
type VersionList = api_v1alpha1.VersionList
