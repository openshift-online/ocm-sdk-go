...
const NodePoolAutoscalingKind = api_v1alpha1.NodePoolAutoscalingKind

// NodePoolAutoscalingLinkKind is the name of the type used to represent links
// to objects of type 'node_pool_autoscaling'.
const NodePoolAutoscalingLinkKind = api_v1alpha1.NodePoolAutoscalingLinkKind

// NodePoolAutoscalingNilKind is the name of the type used to nil references
// to objects of type 'node_pool_autoscaling'.
const NodePoolAutoscalingNilKind = api_v1alpha1.NodePoolAutoscalingNilKind

// NodePoolAutoscaling represents the values of the 'node_pool_autoscaling' type.
//
// Representation of a autoscaling in a node pool.
type NodePoolAutoscaling = api_v1alpha1.NodePoolAutoscaling
type NodePoolAutoscalingList = api_v1alpha1.NodePoolAutoscalingList
