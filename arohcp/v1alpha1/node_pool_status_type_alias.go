...
const NodePoolStatusKind = api_v1alpha1.NodePoolStatusKind

// NodePoolStatusLinkKind is the name of the type used to represent links
// to objects of type 'node_pool_status'.
const NodePoolStatusLinkKind = api_v1alpha1.NodePoolStatusLinkKind

// NodePoolStatusNilKind is the name of the type used to nil references
// to objects of type 'node_pool_status'.
const NodePoolStatusNilKind = api_v1alpha1.NodePoolStatusNilKind

// NodePoolStatus represents the values of the 'node_pool_status' type.
//
// Representation of the status of a node pool.
type NodePoolStatus = api_v1alpha1.NodePoolStatus
type NodePoolStatusList = api_v1alpha1.NodePoolStatusList
