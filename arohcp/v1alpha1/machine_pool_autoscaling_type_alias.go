...
const MachinePoolAutoscalingKind = api_v1alpha1.MachinePoolAutoscalingKind
...
const MachinePoolAutoscalingLinkKind = api_v1alpha1.MachinePoolAutoscalingLinkKind

// MachinePoolAutoscalingNilKind is the name of the type used to nil references
// to objects of type 'machine_pool_autoscaling'.
const MachinePoolAutoscalingNilKind = api_v1alpha1.MachinePoolAutoscalingNilKind
...
type MachinePoolAutoscaling = api_v1alpha1.MachinePoolAutoscaling
type MachinePoolAutoscalingList = api_v1alpha1.MachinePoolAutoscalingList
