...
const KubeletConfigKind = api_v1alpha1.KubeletConfigKind

// KubeletConfigLinkKind is the name of the type used to represent links
// to objects of type 'kubelet_config'.
const KubeletConfigLinkKind = api_v1alpha1.KubeletConfigLinkKind

// KubeletConfigNilKind is the name of the type used to nil references
// to objects of type 'kubelet_config'.
const KubeletConfigNilKind = api_v1alpha1.KubeletConfigNilKind
...
type KubeletConfig = api_v1alpha1.KubeletConfig
type KubeletConfigList = api_v1alpha1.KubeletConfigList
