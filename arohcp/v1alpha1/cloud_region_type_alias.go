...
const CloudRegionKind = api_v1alpha1.CloudRegionKind

// CloudRegionLinkKind is the name of the type used to represent links
// to objects of type 'cloud_region'.
const CloudRegionLinkKind = api_v1alpha1.CloudRegionLinkKind

// CloudRegionNilKind is the name of the type used to nil references
// to objects of type 'cloud_region'.
const CloudRegionNilKind = api_v1alpha1.CloudRegionNilKind

// CloudRegion represents the values of the 'cloud_region' type.
//
// Description of a region of a cloud provider.
type CloudRegion = api_v1alpha1.CloudRegion
type CloudRegionList = api_v1alpha1.CloudRegionList
