...
const RegistryAllowlistKind = api_v1alpha1.RegistryAllowlistKind

// RegistryAllowlistLinkKind is the name of the type used to represent links
// to objects of type 'registry_allowlist'.
const RegistryAllowlistLinkKind = api_v1alpha1.RegistryAllowlistLinkKind

// RegistryAllowlistNilKind is the name of the type used to nil references
// to objects of type 'registry_allowlist'.
const RegistryAllowlistNilKind = api_v1alpha1.RegistryAllowlistNilKind
...
type RegistryAllowlist = api_v1alpha1.RegistryAllowlist
type RegistryAllowlistList = api_v1alpha1.RegistryAllowlistList
