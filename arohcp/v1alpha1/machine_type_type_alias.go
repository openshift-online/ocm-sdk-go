...
const MachineTypeKind = api_v1alpha1.MachineTypeKind

// MachineTypeLinkKind is the name of the type used to represent links
// to objects of type 'machine_type'.
const MachineTypeLinkKind = api_v1alpha1.MachineTypeLinkKind

// MachineTypeNilKind is the name of the type used to nil references
// to objects of type 'machine_type'.
const MachineTypeNilKind = api_v1alpha1.MachineTypeNilKind

// MachineType represents the values of the 'machine_type' type.
//
// Machine type.
type MachineType = api_v1alpha1.MachineType
type MachineTypeList = api_v1alpha1.MachineTypeList
