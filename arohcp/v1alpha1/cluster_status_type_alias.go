...
const ClusterStatusKind = api_v1alpha1.ClusterStatusKind

// ClusterStatusLinkKind is the name of the type used to represent links
// to objects of type 'cluster_status'.
const ClusterStatusLinkKind = api_v1alpha1.ClusterStatusLinkKind

// ClusterStatusNilKind is the name of the type used to nil references
// to objects of type 'cluster_status'.
const ClusterStatusNilKind = api_v1alpha1.ClusterStatusNilKind

// ClusterStatus represents the values of the 'cluster_status' type.
//
// Detailed status of a cluster.
type ClusterStatus = api_v1alpha1.ClusterStatus
type ClusterStatusList = api_v1alpha1.ClusterStatusList
