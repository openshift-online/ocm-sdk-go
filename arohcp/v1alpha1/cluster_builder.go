...
func (b *ClusterBuilder) Capabilities(value *ClusterCapabilitiesConfigBuilder) *ClusterBuilder {
...
func (b *ClusterBuilder) Copy(object *Cluster) *ClusterBuilder {
	...
	if object.capabilities != nil {
		b.capabilities = NewClusterCapabilitiesConfig().Copy(object.capabilities)
	} else {
		b.capabilities = nil
	}
