...
const CloudProviderKind = api_v1alpha1.CloudProviderKind

// CloudProviderLinkKind is the name of the type used to represent links
// to objects of type 'cloud_provider'.
const CloudProviderLinkKind = api_v1alpha1.CloudProviderLinkKind

// CloudProviderNilKind is the name of the type used to nil references
// to objects of type 'cloud_provider'.
const CloudProviderNilKind = api_v1alpha1.CloudProviderNilKind

// CloudProvider represents the values of the 'cloud_provider' type.
//
// Cloud provider.
type CloudProvider = api_v1alpha1.CloudProvider
type CloudProviderList = api_v1alpha1.CloudProviderList
