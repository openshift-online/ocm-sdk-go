...
const ImageOverridesKind = api_v1alpha1.ImageOverridesKind

// ImageOverridesLinkKind is the name of the type used to represent links
// to objects of type 'image_overrides'.
const ImageOverridesLinkKind = api_v1alpha1.ImageOverridesLinkKind

// ImageOverridesNilKind is the name of the type used to nil references
// to objects of type 'image_overrides'.
const ImageOverridesNilKind = api_v1alpha1.ImageOverridesNilKind
...
type ImageOverrides = api_v1alpha1.ImageOverrides
type ImageOverridesList = api_v1alpha1.ImageOverridesList
