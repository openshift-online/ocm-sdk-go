...
const StatusUpdateKind = api_v1.StatusUpdateKind

// StatusUpdateLinkKind is the name of the type used to represent links
// to objects of type 'status_update'.
const StatusUpdateLinkKind = api_v1.StatusUpdateLinkKind

// StatusUpdateNilKind is the name of the type used to nil references
// to objects of type 'status_update'.
const StatusUpdateNilKind = api_v1.StatusUpdateNilKind

// StatusUpdate represents the values of the 'status_update' type.
type StatusUpdate = api_v1.StatusUpdate
type StatusUpdateList = api_v1.StatusUpdateList
