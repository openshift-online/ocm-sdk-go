...
const ApplicationDependencyKind = api_v1.ApplicationDependencyKind

// ApplicationDependencyLinkKind is the name of the type used to represent links
// to objects of type 'application_dependency'.
const ApplicationDependencyLinkKind = api_v1.ApplicationDependencyLinkKind

// ApplicationDependencyNilKind is the name of the type used to nil references
// to objects of type 'application_dependency'.
const ApplicationDependencyNilKind = api_v1.ApplicationDependencyNilKind
...
type ApplicationDependency = api_v1.ApplicationDependency
type ApplicationDependencyList = api_v1.ApplicationDependencyList
