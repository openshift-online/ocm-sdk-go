...
const LimitedSupportReasonOverrideKind = api_v1.LimitedSupportReasonOverrideKind
...
const LimitedSupportReasonOverrideLinkKind = api_v1.LimitedSupportReasonOverrideLinkKind

// LimitedSupportReasonOverrideNilKind is the name of the type used to nil references
// to objects of type 'limited_support_reason_override'.
const LimitedSupportReasonOverrideNilKind = api_v1.LimitedSupportReasonOverrideNilKind
...
type LimitedSupportReasonOverride = api_v1.LimitedSupportReasonOverride
type LimitedSupportReasonOverrideList = api_v1.LimitedSupportReasonOverrideList
