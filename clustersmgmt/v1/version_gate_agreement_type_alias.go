...
const VersionGateAgreementKind = api_v1.VersionGateAgreementKind

// VersionGateAgreementLinkKind is the name of the type used to represent links
// to objects of type 'version_gate_agreement'.
const VersionGateAgreementLinkKind = api_v1.VersionGateAgreementLinkKind

// VersionGateAgreementNilKind is the name of the type used to nil references
// to objects of type 'version_gate_agreement'.
const VersionGateAgreementNilKind = api_v1.VersionGateAgreementNilKind
...
type VersionGateAgreement = api_v1.VersionGateAgreement
type VersionGateAgreementList = api_v1.VersionGateAgreementList
