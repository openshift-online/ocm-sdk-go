...
const AddOnInstallationParameterKind = api_v1.AddOnInstallationParameterKind
...
const AddOnInstallationParameterLinkKind = api_v1.AddOnInstallationParameterLinkKind

// AddOnInstallationParameterNilKind is the name of the type used to nil references
// to objects of type 'add_on_installation_parameter'.
const AddOnInstallationParameterNilKind = api_v1.AddOnInstallationParameterNilKind
...
type AddOnInstallationParameter = api_v1.AddOnInstallationParameter
type AddOnInstallationParameterList = api_v1.AddOnInstallationParameterList
