...
type ClusterBuilder struct {
	...
	capabilities                      *ClusterCapabilitiesSpecBuilder
...
func (b *ClusterBuilder) Capabilities(value *ClusterCapabilitiesSpecBuilder) *ClusterBuilder {
...
func (b *ClusterBuilder) Copy(object *Cluster) *ClusterBuilder {
	...
	if object.capabilities != nil {
		b.capabilities = NewClusterCapabilitiesSpec().Copy(object.capabilities)
	} else {
		b.capabilities = nil
	}
