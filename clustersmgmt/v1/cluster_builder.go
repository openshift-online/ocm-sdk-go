...
type ClusterBuilder struct {
	...
	capabilities                      []*ClusterCapabilitiesConfigBuilder
...
func (b *ClusterBuilder) Capabilities(values ...*ClusterCapabilitiesConfigBuilder) *ClusterBuilder {
	b.capabilities = make([]*ClusterCapabilitiesConfigBuilder, len(values))
...
func (b *ClusterBuilder) Copy(object *Cluster) *ClusterBuilder {
	...
	if object.capabilities != nil {
		b.capabilities = make([]*ClusterCapabilitiesConfigBuilder, len(object.capabilities))
		for i, v := range object.capabilities {
			b.capabilities[i] = NewClusterCapabilitiesConfig().Copy(v)
		}
	} else {
		b.capabilities = nil
	}
...
func (b *ClusterBuilder) Build() (object *Cluster, err error) {
	...
	if b.capabilities != nil {
		object.capabilities = make([]*ClusterCapabilitiesConfig, len(b.capabilities))
