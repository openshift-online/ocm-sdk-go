...
type ClusterBuilder struct {
	...
	disabledCapabilities              []OptionalClusterCapability
	domainPrefix                      string
...
// DisabledCapabilities sets the value of the 'disabled_capabilities' attribute to the given values.
func (b *ClusterBuilder) DisabledCapabilities(values ...OptionalClusterCapability) *ClusterBuilder {
	b.disabledCapabilities = make([]OptionalClusterCapability, len(values))
	copy(b.disabledCapabilities, values)
	b.bitmap_ |= 8388608
	return b
}
...
func (b *ClusterBuilder) Copy(object *Cluster) *ClusterBuilder {
	...
	if object.disabledCapabilities != nil {
		b.disabledCapabilities = make([]OptionalClusterCapability, len(object.disabledCapabilities))
		copy(b.disabledCapabilities, object.disabledCapabilities)
	} else {
		b.disabledCapabilities = nil
	}
...
func (b *ClusterBuilder) Build() (object *Cluster, err error) {
	...
	if b.disabledCapabilities != nil {
		object.disabledCapabilities = make([]OptionalClusterCapability, len(b.disabledCapabilities))
		copy(object.disabledCapabilities, b.disabledCapabilities)
	}
