...
const ProductTechnologyPreviewKind = api_v1.ProductTechnologyPreviewKind
...
const ProductTechnologyPreviewLinkKind = api_v1.ProductTechnologyPreviewLinkKind

// ProductTechnologyPreviewNilKind is the name of the type used to nil references
// to objects of type 'product_technology_preview'.
const ProductTechnologyPreviewNilKind = api_v1.ProductTechnologyPreviewNilKind
...
type ProductTechnologyPreview = api_v1.ProductTechnologyPreview
type ProductTechnologyPreviewList = api_v1.ProductTechnologyPreviewList
