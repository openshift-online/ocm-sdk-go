...
// TaintKind is the name of the type used to represent objects
// of type 'taint'.
const TaintKind = "Taint"

// TaintLinkKind is the name of the type used to represent links
// to objects of type 'taint'.
const TaintLinkKind = "TaintLink"

// TaintNilKind is the name of the type used to nil references
// to objects of type 'taint'.
const TaintNilKind = "TaintNil"
...
func (o *Taint) Kind() string {
	if o == nil {
		return TaintNilKind
	}
	if o.link {
		return TaintLinkKind
	}
	return TaintKind
}

// ID returns the identifier of the object.
func (o *Taint) ID() string {
	if o != nil && o.id != nil {
		return *o.id
	}
	return ""
...
func (o *Taint) GetID() (value string, ok bool) {
	ok = o != nil && o.id != nil
	if ok {
		value = *o.id
	}
...
func (o *Taint) Link() bool {
	return o != nil && o.link
}

// HREF returns the link to the object.
func (o *Taint) HREF() string {
	if o != nil && o.href != nil {
		return *o.href
	}
	return ""
...
// link has a value.
func (o *Taint) GetHREF() (value string, ok bool) {
	ok = o != nil && o.href != nil
	if ok {
		value = *o.href
	}
...
// Kind returns the name of the type of the object.
func (l *TaintList) Kind() string {
	if l == nil {
		return TaintListNilKind
	}
	if l.link {
		return TaintListLinkKind
	}
	return TaintListKind
}

// Link returns true iif this is a link.
func (l *TaintList) Link() bool {
	return l != nil && l.link
}

// HREF returns the link to the list.
func (l *TaintList) HREF() string {
	if l != nil && l.href != nil {
		return *l.href
	}
	return ""
...
// link has a value.
func (l *TaintList) GetHREF() (value string, ok bool) {
	ok = l != nil && l.href != nil
	if ok {
		value = *l.href
	}
