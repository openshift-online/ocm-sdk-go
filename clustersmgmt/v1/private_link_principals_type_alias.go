...
const PrivateLinkPrincipalsKind = api_v1.PrivateLinkPrincipalsKind

// PrivateLinkPrincipalsLinkKind is the name of the type used to represent links
// to objects of type 'private_link_principals'.
const PrivateLinkPrincipalsLinkKind = api_v1.PrivateLinkPrincipalsLinkKind

// PrivateLinkPrincipalsNilKind is the name of the type used to nil references
// to objects of type 'private_link_principals'.
const PrivateLinkPrincipalsNilKind = api_v1.PrivateLinkPrincipalsNilKind
...
type PrivateLinkPrincipals = api_v1.PrivateLinkPrincipals
type PrivateLinkPrincipalsList = api_v1.PrivateLinkPrincipalsList
