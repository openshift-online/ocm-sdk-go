...
func readInstallLogsListRequest(request *InstallLogsListServerRequest, r *http.Request) error {
	var err error
	query := r.URL.Query()
...
func writeInstallLogsListRequest(request *InstallLogsListRequest, writer io.Writer) error {
	return nil
}
func readInstallLogsListResponse(response *InstallLogsListResponse, reader io.Reader) error {
...
func writeInstallLogsListResponse(response *InstallLogsListServerResponse, w http.ResponseWriter) error {
