...
const ClusterCredentialsKind = api_v1.ClusterCredentialsKind

// ClusterCredentialsLinkKind is the name of the type used to represent links
// to objects of type 'cluster_credentials'.
const ClusterCredentialsLinkKind = api_v1.ClusterCredentialsLinkKind

// ClusterCredentialsNilKind is the name of the type used to nil references
// to objects of type 'cluster_credentials'.
const ClusterCredentialsNilKind = api_v1.ClusterCredentialsNilKind

// ClusterCredentials represents the values of the 'cluster_credentials' type.
//
// Credentials of the a cluster.
type ClusterCredentials = api_v1.ClusterCredentials
type ClusterCredentialsList = api_v1.ClusterCredentialsList
