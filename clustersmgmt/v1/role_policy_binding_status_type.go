...
// the zero value of the type if the attribute doesn't have a value.
func (o *RolePolicyBindingStatus) Value() RolePolicyBindingStatusType {
	if o != nil && o.bitmap_&2 != 0 {
		return o.value
	}
	return RolePolicyBindingStatusType("")
}

// GetValue returns the value of the 'value' attribute and
// a flag indicating if the attribute has a value.
func (o *RolePolicyBindingStatus) GetValue() (value RolePolicyBindingStatusType, ok bool) {
