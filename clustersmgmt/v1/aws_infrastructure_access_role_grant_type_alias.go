...
const AWSInfrastructureAccessRoleGrantKind = api_v1.AWSInfrastructureAccessRoleGrantKind
...
const AWSInfrastructureAccessRoleGrantLinkKind = api_v1.AWSInfrastructureAccessRoleGrantLinkKind

// AWSInfrastructureAccessRoleGrantNilKind is the name of the type used to nil references
// to objects of type 'AWS_infrastructure_access_role_grant'.
const AWSInfrastructureAccessRoleGrantNilKind = api_v1.AWSInfrastructureAccessRoleGrantNilKind
...
type AWSInfrastructureAccessRoleGrant = api_v1.AWSInfrastructureAccessRoleGrant
type AWSInfrastructureAccessRoleGrantList = api_v1.AWSInfrastructureAccessRoleGrantList
