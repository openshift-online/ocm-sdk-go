...
func readUninstallLogsListRequest(request *UninstallLogsListServerRequest, r *http.Request) error {
	var err error
	query := r.URL.Query()
...
func writeUninstallLogsListRequest(request *UninstallLogsListRequest, writer io.Writer) error {
	return nil
}
func readUninstallLogsListResponse(response *UninstallLogsListResponse, reader io.Reader) error {
...
func writeUninstallLogsListResponse(response *UninstallLogsListServerResponse, w http.ResponseWriter) error {
