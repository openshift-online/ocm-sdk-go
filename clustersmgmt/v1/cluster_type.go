...
// DisabledCapabilities returns the value of the 'disabled_capabilities' attribute, or
// the zero value of the type if the attribute doesn't have a value.
//
// Disabled capabilities
func (o *Cluster) DisabledCapabilities() []OptionalClusterCapability {
	if o != nil && o.bitmap_&8388608 != 0 {
		return o.disabledCapabilities
	}
	return nil
}

// GetDisabledCapabilities returns the value of the 'disabled_capabilities' attribute and
// a flag indicating if the attribute has a value.
//
// Disabled capabilities
func (o *Cluster) GetDisabledCapabilities() (value []OptionalClusterCapability, ok bool) {
	ok = o != nil && o.bitmap_&8388608 != 0
	if ok {
		value = o.disabledCapabilities
	}
	return
}
