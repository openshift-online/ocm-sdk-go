...
const AWSSpotMarketOptionsKind = api_v1.AWSSpotMarketOptionsKind

// AWSSpotMarketOptionsLinkKind is the name of the type used to represent links
// to objects of type 'AWS_spot_market_options'.
const AWSSpotMarketOptionsLinkKind = api_v1.AWSSpotMarketOptionsLinkKind

// AWSSpotMarketOptionsNilKind is the name of the type used to nil references
// to objects of type 'AWS_spot_market_options'.
const AWSSpotMarketOptionsNilKind = api_v1.AWSSpotMarketOptionsNilKind

// AWSSpotMarketOptions represents the values of the 'AWS_spot_market_options' type.
//
// Spot market options for AWS machine pool.
type AWSSpotMarketOptions = api_v1.AWSSpotMarketOptions
type AWSSpotMarketOptionsList = api_v1.AWSSpotMarketOptionsList
