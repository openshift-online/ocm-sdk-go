...
const NodePoolManagementUpgradeKind = api_v1.NodePoolManagementUpgradeKind
...
const NodePoolManagementUpgradeLinkKind = api_v1.NodePoolManagementUpgradeLinkKind

// NodePoolManagementUpgradeNilKind is the name of the type used to nil references
// to objects of type 'node_pool_management_upgrade'.
const NodePoolManagementUpgradeNilKind = api_v1.NodePoolManagementUpgradeNilKind
...
type NodePoolManagementUpgrade = api_v1.NodePoolManagementUpgrade
type NodePoolManagementUpgradeList = api_v1.NodePoolManagementUpgradeList
