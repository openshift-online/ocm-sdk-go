...
func (c *MachineTypeClient) Get() *MachineTypeGetRequest {
	request := new(MachineTypeGetRequest)
...
func (r *MachineTypeGetRequest) SendContext(ctx context.Context) (result *MachineTypeGetResponse, err error) {
	...
	result = new(MachineTypeGetResponse)
...
// 'get' method.
func (r *MachineTypeGetResponse) unmarshal(reader io.Reader) error {
	var err error
