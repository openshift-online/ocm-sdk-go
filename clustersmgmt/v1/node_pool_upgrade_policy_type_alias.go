...
const NodePoolUpgradePolicyKind = api_v1.NodePoolUpgradePolicyKind

// NodePoolUpgradePolicyLinkKind is the name of the type used to represent links
// to objects of type 'node_pool_upgrade_policy'.
const NodePoolUpgradePolicyLinkKind = api_v1.NodePoolUpgradePolicyLinkKind

// NodePoolUpgradePolicyNilKind is the name of the type used to nil references
// to objects of type 'node_pool_upgrade_policy'.
const NodePoolUpgradePolicyNilKind = api_v1.NodePoolUpgradePolicyNilKind
...
type NodePoolUpgradePolicy = api_v1.NodePoolUpgradePolicy
type NodePoolUpgradePolicyList = api_v1.NodePoolUpgradePolicyList
